...
from constants.choices import ENTSCHEIDUNG_STATUS
...
class Offer(models.Model):
    ...
    status = models.CharField(verbose_name='Status', max_length=255, choices=ENTSCHEIDUNG_STATUS, default='Betätigt')

    contact_reference = models.ForeignKey(to=Contact, related_name='offers', on_delete=models.CASCADE)
